...
if __name__ == '__main__':
    ...
    for index in ['B3', 'B4', 'B5', 'B6', 'B7', 'B8', 'B8A', 'B9', 'OSAVI_20m', 'NDVI_20m']:
        ...
        dcs_temp = RS_dcs(dc_temp_dic['MNDWI'], dc_temp)
        dcs_temp.inundation_removal(index, 'MNDWI_thr')
        dcs_temp = None
    ...
    dcs_temp.link_GEDI_RS_dc('G:\A_veg\S2_all\GEDI\\MID_YZR_high_quality.xlsx', ['NDVI_20m_noninun', 'OSAVI_20m_noninun'], retrieval_method='linear_interpolation')
    ...
    dcs_temp.link_GEDI_RS_dc('G:\A_veg\S2_all\GEDI\\MID_YZR_high_quality.xlsx', ['B8A_noninun', 'MNDWI'], retrieval_method='linear_interpolation')
