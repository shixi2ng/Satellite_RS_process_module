...
from Landsat_toolbox.Landsat_main_v2 import Landsat_dc, Landsat_l2_ds


if __name__ == '__main__':

    guide = Landsat_l2_ds('D:\\A_HH_upper\\Guide_upperhh\\Original_zipfiles\\')
    guide.construct_metadata(unzipped_para=False)
    guide.mp_construct_index([ 'MNDWI'], cloud_removal_para=True, size_control_factor=True, ROI='D:\\A_HH_upper\\A_Project\\ROI_guide\\guide\\guide_ent.shp',)
