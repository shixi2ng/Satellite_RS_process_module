...
if __name__ == '__main__':
    ...
    for outputpath in ['prewl_predem','prewl_postdem','postwl_predem','postwl_postdem' ]:
        dir = 'G:\\A_Landsat_veg\\Water_level_python\\inundation_status\\' + str(outputpath) + '\\inundation_freq.TIF'
        ds = gdal.Open(dir)
    ...
    contribution_wl = ((arr_dic['postwl_postdem'] - arr_dic['prewl_postdem'] + arr_dic['postwl_predem'] - arr_dic['prewl_predem']) /
                        ((arr_dic['prewl_postdem'] - arr_dic['prewl_predem'] + arr_dic['postwl_postdem'] - arr_dic['postwl_predem']) + (arr_dic['postwl_postdem'] - arr_dic['prewl_postdem'] + arr_dic['postwl_predem'] - arr_dic['prewl_predem'])))
    bf.write_raster(ds, contribution_dam, 'G:\\A_Landsat_veg\\Water_level_python\\inundation_status\\', 'dam_contribution.TIF', raster_datatype=gdal.GDT_Float32)
    bf.write_raster(ds, contribution_wl, 'G:\\A_Landsat_veg\\Water_level_python\\inundation_status\\', 'wl_contribution.TIF', raster_datatype=gdal.GDT_Float32)

    for outputpath in ['prewl_predem','prewl_postdem','postwl_predem','postwl_postdem' ]:
        dir = 'G:\\A_Landsat_veg\\Water_level_python\\inundation_status\\' + str(outputpath) + '\\'
    ...
    if not os.path.exists('G:\A_Landsat_veg\Water_level_python\Post_TGD\\ele_posttgd4model.TIF') or \
        ...
        post_inun_ds = gdal.Open('G:\A_Landsat_veg\Water_level_python\Post_TGD\\inun_DT_inundation_frequency_posttgd.TIF')
    ...
    #     hydrodc1.seq_simplified_conceptual_inundation_model('G:\\A_Landsat_veg\\Water_level_python\\Post_TGD\\ele_pretgd4model.TIF', thal1, 'G:\A_Landsat_veg\Water_level_python\inundation_status\\prewl_predem\\')
    ...
    cs1.compare_2ddem('G:\\A_Landsat_veg\\Water_level_python\\Post_TGD\\ele_DT_inundation_frequency_posttgd.TIF', inun_freq='G:\\A_Landsat_veg\\Landsat_floodplain_2020_datacube\\Inundation_DT_datacube\\inun_factor\\DT_inundation_frequency_posttgd.TIF')

    # Cross section construction pre-TGD
    cs2 = CrossSection('G:\\A_Landsat_veg\\Water_level_python\\Pre_TGD\\')
    cs2.from_stdCSfiles('G:\\A_Landsat_veg\\Water_level_python\\Original_cross_section\\cross_section_DEM_2003.xlsx')
    ...
    cs2.to_shpfile()
    cs2.to_csv()
    cs2.compare_2ddem('G:\\A_Landsat_veg\\Water_level_python\\Pre_TGD\\ele_DT_inundation_frequency_pretgd.TIF', inun_freq='G:\\A_Landsat_veg\\Landsat_floodplain_2020_datacube\\Inundation_DT_datacube\\inun_factor\\DT_inundation_frequency_pretgd.TIF')